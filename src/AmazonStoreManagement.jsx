  ...
  const features = [
    {
      icon: Megaphone,
      title: "Amazon PPC",
      desc: "High converting sponsored ads and ACOS optimization.",
    },
    {
      icon: Package,
      title: "Product Listings",
      desc: "SEO optimized listings with premium copywriting.",
    },
    {
      icon: Boxes,
      title: "Inventory Management",
      desc: "FBA shipment planning and stock monitoring.",
    },
    {
      icon: BadgeDollarSign,
      title: "Brand Growth",
      desc: "Brand registry, A+ content and scaling strategy.",
    },
  ];
        ...
        <section className="relative px-6 md:px-16 py-28">
          ...
          >
            ...
            <p className="mt-8 text-lg text-white/60 max-w-2xl leading-relaxed">
              Complete Amazon store management solutions including product listing optimization,
              PPC campaign management, A+ content creation, FBA/FBM handling, inventory
              management, keyword research and full account growth strategy.
            </p>

            <motion.a
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              href="/project-form?service=amazon"
