  ...
  const features = [
    {
      ...
      desc: "Premium responsive storefronts with modern UI/UX.",
    },
    {
      icon: ShoppingCart,
      title: "Product Page Optimization",
      desc: "High converting product layouts and sales focused design.",
    },
    {
      icon: Plug,
      title: "App Integrations",
      desc: "Payment gateways, apps and automation integrations.",
    },
    {
      icon: Zap,
      title: "Speed Optimization",
      desc: "Fast loading Shopify stores optimized for conversions.",
    },
  ];
        ...
        <section className="relative px-6 md:px-16 py-28">
          ...
          >
            ...
            <p className="mt-8 text-lg text-white/60 max-w-2xl leading-relaxed">
              Custom Shopify store development services including premium themes,
              high-converting product pages, speed optimization, app integrations,
              responsive UI/UX and complete eCommerce brand setup solutions.
            </p>

            <motion.a
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              href="/project-form?service=shopify"
