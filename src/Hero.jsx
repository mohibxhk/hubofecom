    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 grid lg:grid-cols-12 gap-12 items-center min-h-[calc(100vh-7rem)]">
        ...
        >
          ...
          >
            We build premium websites using react, CSS Tailwind, Modern Frame, node.js, Java Script and scale eCommerce brands through Shopify, WooCommerce, Amazon, eBay, Walmart & TikTok Shop with modern UI/UX, development and growth strategies worldwide.
          </motion.p>
