  ...
  const features = [
    {
      ...
      desc: "SEO optimized product listings for better visibility.",
    },
    {
      icon: Megaphone,
      title: "Walmart Ads",
      desc: "Walmart Connect advertising and campaign optimization.",
    },
    {
      icon: Boxes,
      title: "Catalog Management",
      desc: "Variant setup, inventory sync and bulk management.",
    },
    {
      icon: TrendingUp,
      title: "Marketplace Growth",
      desc: "Scaling strategies to increase sales and performance.",
    },
  ];
        ...
        <section className="relative px-6 md:px-16 py-28">
          ...
          >
            ...
            <p className="mt-8 text-lg text-white/60 max-w-2xl leading-relaxed">
              Professional Walmart marketplace management services including seller account
              setup, product listing optimization, catalog management, repricing strategy,
              Walmart Connect advertising and complete store growth solutions.
            </p>

            <motion.a
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              href="/project-form?service=walmart"
